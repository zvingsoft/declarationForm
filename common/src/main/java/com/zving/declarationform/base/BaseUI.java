...
public class BaseUI {
	...
	public ResponseDTO success(String message, String data) {
		return response(SUCESS, message, data, 0);
	}

	public ResponseDTO success(String message, String data, int total) {
		return response(SUCESS, message, data, total);
	}

	public ResponseDTO response(int status, String message, String data, int total) {
