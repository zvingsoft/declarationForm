...
public class License {
	...
	private String importandexportcode;
	...
	private String conmpanyaddress;
	private String conmpanytype;
	...
	public String getConmpanyaddress() {
		return conmpanyaddress;
	}

	public void setConmpanyaddress(String conmpanyaddress) {
		this.conmpanyaddress = conmpanyaddress;
	}

	public String getConmpanytype() {
		return conmpanytype;
	}

	public void setConmpanytype(String conmpanytype) {
		this.conmpanytype = conmpanytype;
	}
